@extends('master')
@section('title', 'Expéreinces professionnelles')
@section('content')

<main class="container">
    <div class="text-center py-5 mb-5">
        <h1 class="display-5 fw-bolder mb-0">Expéreinces professionnelles</h1>
    </div>
    <div class="col-lg-11 col-xl-9 col-xxl-8 w-100">
